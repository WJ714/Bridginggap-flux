...
# url \<-
# "<https://raw.githubusercontent.com/yourusername/yourrepo/main/data/yourfile.csv>"
# df \<- read.csv(url)
```
...
Please note: The naming conventions for varibles are different for different sites;
```{r}
...
After meeting with other organizers: - download and organise FLUXNET
data from all study sites (+ some figures about the annual variation
...?) - format output similar to FLUXNET data? - LE and H: LSM model
output? format of LSM model ... -
