...
# Read data on google drive (experimenting)
- If you are using binder for this tutorial
```{r}
# if it does not work, comment the codes and download data the read from your local drive manually
library(googledrive)
...
ylab = expression("NEE" ~ "(" * gC ~ m^{-2} ~ year^{-1} * ")")
