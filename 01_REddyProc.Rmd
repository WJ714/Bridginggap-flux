...
#     agree_policy = TRUE,
#     intended_use = "other",
#     intended_use_text = "FLUXNET_workshop",
#     verbose = TRUE,
#     out_dir = tmp_dir
#   )
...
```{r}
EProc$sSetLocationInfo(LatDeg = 46.2420, LongDeg =-89.3477, TimeZoneHour = -6) # TimeZoneHour: time zone offset from UTC (Coordinated Universal Time), local time without daytime saving. This is a site-specific input. 
EProc$sFillVPDFromDew() # fill longer gaps still present in VPD_f
EProc$sMRFluxPartitionUStarScens("NEE") # night-time

# If you want to explore day-time or night-time partitioning
...
-   REddyProc Q&A: https://www.bgc-jena.mpg.de/5629512/FAQ 
